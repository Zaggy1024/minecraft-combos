...
import zaggy1024.combo.variant.MultiMetadataList.*;
import zaggy1024.util.MiscUtils;

/**
 * Used to combine IMetadata subclasses under a single class, as Enums are forced to fit {@code T extends Comparable<T>},
 * so that they cannot be sorted together.
 * 
 * @author Zaggy1024
 */
