...
/**
 * Used to keep track of a set of properties with each one corresponding to one side of a block.
 * Useful for blocks with multiple parts resting on the sides of adjacent blocks.
 * 
 * @author Zaggy1024
 */
